...
(function(s) {
  ...
  l = function() {
    ...
    c.innerHTML = m, m = null, (c = c.getElementsByTagName("svg")[0]) && (c.setAttribute("aria-hidden", "true"), c.style.position = "absolute", c.style.width = 0, c.style.height = 0, c.style.overflow = "hidden", c = c, (t = document.body).firstChild ? z(c, t.firstChild) : t.appendChild(c));
  }, document.addEventListener ? ~["complete", "loaded", "interactive"].indexOf(document.readyState) ? setTimeout(l, 0) : (o = function() {
    document.removeEventListener("DOMContentLoaded", o, false), l();
  }, document.addEventListener("DOMContentLoaded", o, false)) : document.attachEvent && (i = l, h = s.document, a = false, p(), h.onreadystatechange = function() {
    h.readyState == "complete" && (h.onreadystatechange = null, d());
  });
})(window);
//# sourceMappingURL=iconfont-KWBXV3AN.js.map
